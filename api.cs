...
namespace KeyAuth
{
  public class api
  {
    ...
    {
      if ((string.IsNullOrWhiteSpace(name) || string.IsNullOrWhiteSpace(ownerid) || string.IsNullOrWhiteSpace(secret) ? 1 : (string.IsNullOrWhiteSpace(version) ? 1 : 0)) != 0)
      {
    ...
    public string var(string varid)
    {
      ...
      this.load_response_struct(generic);
      return !generic.success ? (string) null : generic.message;
    }
